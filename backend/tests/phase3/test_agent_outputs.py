...
class TestSentimentAgentOutput:
    ...
    async def test_adjusted_not_greater_than_raw_when_bots_present(
        self, aapl_sentiment_signal
    ):
        from backend.core.data_models import SentimentSignal
