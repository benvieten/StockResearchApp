...
class TestResearchStateSchema:
    ...
    def test_agent_signals_has_reducer(self):
        ...
        assert (
            agent_signals_hint is not None
        ...
        assert operator.add in metadata, (
            "agent_signals reducer must be operator.add — " f"found: {metadata}"
        )
...
class TestRunResearch:
    ...
    async def test_report_has_all_signal_scores(self):
        ...
        assert len(found) == 5, f"Expected all 5 signal scores, found: {found}"
